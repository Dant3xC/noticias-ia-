...
Two items belong to the same cluster when **either**:
    1. Fuzzy title ratio > 0.75, OR
    2. They share the same canonical domain AND have meaningful slug overlap.
